  ...
  return (
    ...
    >
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M77.5 0C67.2827 0 59 8.28273 59 18.5V23.5C59 33.7173 67.2827 42 77.5 42C87.7173 42 96 33.7173 96 23.5V18.5C96 8.28273 87.7173 0 77.5 0ZM77.5 7C71.1487 7 66 12.1487 66 18.5V23.5C66 29.8513 71.1487 35 77.5 35C83.8513 35 89 29.8513 89 23.5V18.5C89 12.1487 83.8513 7 77.5 7Z"
        fill="currentColor"
      />
    </svg>
  );
